...
ushort ValueType::Size() const
{
	...
	static constexpr byte scalarVecSizeTable[] = {0,
		...
		sizeof(uint),   sizeof(T::UVec2),  sizeof(T::UVec3),  sizeof(T::UVec4),
		sizeof(short),  sizeof(T::SVec2),  sizeof(T::SVec3),  sizeof(T::SVec4),
		sizeof(ushort), sizeof(T::USVec2), sizeof(T::USVec3), sizeof(T::USVec4),
		sizeof(sbyte),  sizeof(T::SBVec2), sizeof(T::SBVec3), sizeof(T::SBVec4),

...
public:
	...
	R Call(Args&&... args) final {return ObjectRef->*Method(Cpp::Forward<Args>(args)...);}
...
public:
	FreeFuncCallable(FreeDataFunc func, T&& params): Func(func), Params(Cpp::Move(params)) {}
	...
	R Call(Args&&... args) final {return Func(Params, Cpp::Forward<Args>(args)...);}

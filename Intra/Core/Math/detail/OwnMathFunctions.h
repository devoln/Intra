...
INTRA_NODISCARD constexpr inline float Log(float x) {return float(FixedPointLog(uint(x * 65536)))/65536.0f;}
INTRA_NODISCARD constexpr inline double Log(double x) {return double(FixedPointLog(uint(x * 65536)))/65536.0;}
INTRA_NODISCARD constexpr inline long double Log(long double x) {return static_cast<long double>(FixedPointLog(uint(x * 65536)))/65536.0;}

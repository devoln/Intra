...
#include "System/detail/RuntimeUnifiedMain.hxx"
#endif


#if defined(_MSC_VER) && defined(INTRA_MINIMIZE_CRT)
#define INTRA_NO_FULL_CRT
#include "System/detail/RuntimeMsvcrtOldHelper.hxx"
#endif
...
#ifdef _MSC_VER
#include "System/detail/RuntimeMinMsvcCrtImpl.hxx"
#endif
...
#if INTRA_PLATFORM_ARCH == INTRA_PLATFORM_X86 && defined(_MSC_VER) && (defined(INTRA_NO_FULL_CRT) || defined(INTRA_QIFIST))

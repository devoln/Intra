...
template<typename T> struct Aabb
{
	...
	constexpr forceinline Vector3<T> Min() const noexcept {return Min(A, B);}
	constexpr forceinline Vector3<T> Max() const noexcept {return Max(A, B);}

	constexpr forceinline T MinX() const noexcept {return Min(A.x, B.x);}
	constexpr forceinline T MaxX() const noexcept {return Max(A.x, B.x);}
	constexpr forceinline T MinY() const noexcept {return Min(A.y, B.y);}
	constexpr forceinline T MaxY() const noexcept {return Max(A.y, B.y);}
	constexpr forceinline T MinZ() const noexcept {return Min(A.z, B.z);}
	constexpr forceinline T MaxZ() const noexcept {return Max(A.z, B.z);}

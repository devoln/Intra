...
struct ErrorCode
{
	...
	*/
	INTRA_NODISCARD StringView ToString(Span<char>& dstBuf) const noexcept
	{
...
public:
	...
	constexpr void Error(ErrorCode errorCode, SourceInfo srcInfo = INTRA_DEFAULT_SOURCE_INFO) noexcept
	{
	...
	*/
	INTRA_NODISCARD constexpr forceinline ErrorCode Handle() noexcept
	{
	...
	constexpr forceinline void HandlingFailed() noexcept
	{
...
public:
	...
	constexpr forceinline ErrorReporter(decltype(IgnoreErrors), IFunctor<void(ErrorCode, StringView, SourceInfo)>* logger = null) noexcept: Logger(logger) {}
	constexpr forceinline ErrorReporter(ErrorStatus& status, IFunctor<void(ErrorCode, StringView, SourceInfo)>* logger = null) noexcept: mStatus(&status), Logger(logger) {}

	constexpr forceinline void Error(ErrorCode errorCode, StringView desc, SourceInfo srcInfo = INTRA_DEFAULT_SOURCE_INFO) noexcept
	{

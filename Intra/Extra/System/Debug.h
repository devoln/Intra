...
#define INTRA_HEAP_CHECK INTRA_ASSERT(Intra::C::_heapchk() == -2 /*_HEAPOK*/)
...
#define INTRA_CORE_INTERNAL_MODULE_TEST(uniqueName,qualifiers) \
	...
	static ::Intra::D::ModuleUnitTest INTRA_CONCATENATE_TOKENS(uniqueName, _reg)(&uniqueName, ::Intra::SourceInfo{#uniqueName, __FILE__, unsigned(__LINE__)});\
	static qualifiers void uniqueName()

#ifndef INTRA_NO_UNITTESTS
#define INTRA_MODULE_UNITTEST INTRA_WARNING_DISABLE_GLOBAL_CONSTRUCTION INTRA_CORE_INTERNAL_MODULE_TEST(INTRA_CONCATENATE_TOKENS(intra_unittest__, INTRA_UNIQUE_NUMBER),)

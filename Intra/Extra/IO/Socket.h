...
public:
	...
	StreamSocket(SocketType type, StringView host, ushort port, ErrorReporter err);
...
public:
	...
	ServerSocket(SocketType type, ushort port, size_t maxConnections, ErrorReporter err);

...
public:
	...
	Array(InitializerList<T> values, Allocator& allocator):
	...
	Array(Array&& rhs):
		AllocatorRef(Meta::Move(rhs)), buffer(rhs.buffer), range(rhs.range)
	...
	Range::RLastAppender<Array> Insert(Range::RelativeIndexEnd) {return {*this};}

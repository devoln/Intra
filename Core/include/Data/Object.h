...
public:
	...
	virtual FiniteRandomAccessRange<const IConstObject&> GetObjectArray(StringView key) const = 0;
...
public:
	...
	static_assert(Range::IsFiniteRange<ArrayRange<const Object>>::_, "ERROR!");
	FiniteRandomAccessRange<const IConstObject&> GetObjectArray(StringView key) const override final
	{
		static_assert(Meta::IsConvertible<Object&&, const IConstObject&>::_, "ERROR!");
		return Range::AsRange(mObjectArrays.Get(key));
	}

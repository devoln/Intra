...
InstrumentLibrary::InstrumentLibrary()
{
	...
	// === Перегруженная гитара: спектральная струна (SpectralStringSampler) + перегруз ===
	// Драйв (мягкий клиппинг) -> HPF -> тёмный "кабинет" -> уровень.
	{
		...
		g.Envelope = MakeEnvelope({0.001f, 0, 1, 1.2f, 1.5f, false, true});
	...
	// === Дисторшн-гитара (30): тот же источник, жёстче: ярче (0.75), двухкаскадный драйв
	// (6+3), HPF 100 Гц, темнее "кабинет" (0.055).
	{

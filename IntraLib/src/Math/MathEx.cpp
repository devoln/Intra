...
bool _NaN::operator==(float rhs) const {return isnan(rhs)!=0;}
bool _NaN::operator==(double rhs) const {return isnan(rhs)!=0;}
bool _NaN::operator==(real rhs) const {return isnan((double)rhs)!=0;}

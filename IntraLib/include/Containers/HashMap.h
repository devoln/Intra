...
private:
	forceinline HashTableRange(D::HashNode<T>* startNode, D::HashNode<T>* lastNode):
		mFirstNode(startNode), mLastNode(lastNode) {}

	D::HashNode<T>* mFirstNode;
	D::HashNode<T>* mLastNode;
...
class HashMap: Memory::AllocatorRef<AllocatorType>
{
	...
	typedef D::HashNode<KeyValuePair<const K, V>> Node;
public:

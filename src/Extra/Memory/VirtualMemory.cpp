#include "Extra/Memory/VirtualMemory.h"
...
EXTRA_BEGIN
static unsigned translate_access(Access access)
{
	static const unsigned accessTable[] =
	{
...
AnyPtr VirtualAlloc(size_t bytes, Access access)
{(void)bytes; (void)commit; (void)access; return Misc::CImp::malloc(bytes);}

void VirtualFree(void* ptr, size_t size) {Misc::CImp::free(ptr);}

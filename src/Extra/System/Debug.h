...
#define EXTRA_ASSERT1(expr, arg0) INTRA_LIKELY(expr)? (void)0: (void)(\
    (INTRA_FATAL_ERROR(::Intra::DebugStringView("Assertion " # expr " failed!"\
	"\n" # arg0 " = ")+::Extra::StringOf(arg0)), true))

#define EXTRA_ASSERT2(expr, arg0, arg1) INTRA_LIKELY(expr)? (void)0: (void)(\
    (INTRA_FATAL_ERROR(::Intra::DebugStringView("Assertion " # expr " failed!"\
	"\n" # arg0 " = ") + ::Extra::StringOf(arg0)+\
	"\n" # arg1 " = " + ::Extra::StringOf(arg1)), true))

#define EXTRA_ASSERT3(expr, arg0, arg1, arg2) INTRA_LIKELY(expr)? (void)0: (void)(\
    (INTRA_FATAL_ERROR(::Intra::DebugStringView("Assertion " # expr " failed!"\
	"\n" # arg0 " = ")+ ::Extra::StringOf(arg0)+\
	"\n" # arg1 " = " + ::Extra::StringOf(arg1)+\
	"\n" # arg2 " = " + ::Extra::StringOf(arg2)), true))

#define EXTRA_ASSERT_EQUALS(lhs, rhs) INTRA_LIKELY((lhs) == (rhs))? (void)0: (void)(\
    (INTRA_FATAL_ERROR(::Intra::DebugStringView("Assertion " # lhs " == " # rhs " failed!\n")+\
		::Extra::StringOf((lhs)) + " != " + ::Extra::StringOf((rhs))), true))
...
#define INTRA_HEAP_CHECK INTRA_ASSERT(Intra::CImp::_heapchk() == -2 /*_HEAPOK*/)
...
#define INTRA_MODULE_UNITTEST INTRA_IGNORE_WARNING_GLOBAL_CONSTRUCTION INTRA_CORE_INTERNAL_MODULE_TEST(INTRA_CONCATENATE_TOKENS(intra_unittest_, __COUNTER__),)
